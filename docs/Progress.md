...
| API and UI surface | In progress | Core read and admin surfaces exist, and the dashboard plus list views now surface operational state, filtered counts, empty states, and actionable controls in the shell. Template scaffold pages have been removed. |
